...
//	CBNLSClient *m_BNLSClient;						// the BNLS client (for external warden handling)
	...
	uint32_t m_LastGetSearchGameTime2;
	string m_SearchGameName2;
	uint32_t m_SearchGameNameTime2;
...
public:
	...
	string GetSearchGameName2( )							{ return m_SearchGameName2; }
	void SetSearchGameName2( string nSearchGameName2 )		{ m_SearchGameName2 = nSearchGameName2; m_SearchGameNameTime2 = GetTime( ); }
	uint32_t GetSearchGameNameTime( )						{ return m_SearchGameNameTime; }
	uint32_t GetSearchGameNameTime2( )						{ return m_SearchGameNameTime2; }
